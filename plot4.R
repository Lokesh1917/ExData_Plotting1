...
#plotting graph
        par(mfrow=c(2,2))
        with(datepow,plot(dttm, as.numeric(as.character(Global_active_power)), type="l", xlab="", ylab="Global Active Power", cex=0.2))
        with(datepow,plot(dttm, as.numeric(as.character(Voltage)), type="l", xlab="datetime", ylab="Voltage"))
        ...
        with(datepow,plot(dttm,as.numeric(as.character( Global_reactive_power)), type="l", xlab="datetime", ylab="Global_reactive_power")) 
